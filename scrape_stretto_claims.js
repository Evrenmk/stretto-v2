/**
 * Generic Stretto Filed Claims Scraper + Excel Generator (v3 — fully autonomous)
 *
 * Usage: Open https://cases.stretto.com/<slug>/filed-claims/ in Chrome,
 *        set CASE_NAME / CASE_URL / EXPECTED_TOTAL below for the case,
 ...
 */
(async function StrettoScraper() {
  'use strict';

  // ═══════════════════════ CASE CONFIG (change these per case) ═══════════════════════
  const CASE_NAME     = 'Omnicare';
  const CASE_URL      = 'https://cases.stretto.com/omnicare/filed-claims/';
